...
class ServiceConfig : public ConfigObject {
    ...
    // Dynamic schemes are generated by the CLI, which reads these settings
    // from shell.json before it regenerates scheme.json.
    CONFIG_GLOBAL_PROPERTY(QString, dynamicSchemeBackend, u"legacy"_s)
    CONFIG_GLOBAL_PROPERTY(QString, dynamicSchemeMode, u"auto"_s)
    CONFIG_GLOBAL_PROPERTY(QString, dynamicSchemeLegacyFlavour, u"default"_s)
    CONFIG_GLOBAL_PROPERTY(QString, materialSchemeVariant, u"tonalspot"_s)
    CONFIG_GLOBAL_PROPERTY(qreal, materialSchemeContrastLevel, 0.0)
