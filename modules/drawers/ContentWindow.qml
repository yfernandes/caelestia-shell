...
StyledWindow {
    ...
    WlrLayershell.keyboardFocus: visibilities.launcher || visibilities.session || visibilities.smcMixer ? WlrKeyboardFocus.OnDemand : WlrKeyboardFocus.None
